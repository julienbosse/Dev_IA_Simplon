...
# Configuration
download_path = "home/dataset_pokedex/"
# Images
words_to_search = ['bulbazaur','ivysaur','venusaur']
nb_to_download = list(map(int,np.ones(3)*20))
first_image_position = np.zeros(len(words_to_search))
